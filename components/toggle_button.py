# Original source:
# https://github.com/pythonguis/python-qtwidgets/blob/9a94b504d4922e94e25fe75dc4945615e3d15677/qtwidgets/toggle/toggle.py
# License: MIT License
...
class Toggle(QCheckBox):
    ...
    _light_grey_pen = QPen(Qt.lightGray)  # type: ignore

    def __init__(
        self,
        parent=None,
        bar_color=Qt.gray,  # type: ignore
        checked_color="#00B0FF",
        handle_color=Qt.white,  # type: ignore
    ):
...
class AnimatedToggle(Toggle):
    ...
    def handle_state_change(self, value):
        ...
        if value:
            ...
            orbital_mode.set_is_spinor_mode(True)
        else:
            self.animation.setEndValue(0)
            orbital_mode.set_is_spinor_mode(False)
    ...
    def paintEvent(self, e: QPaintEvent):
        ...
        if self.pulse_anim.state() == QPropertyAnimation.Running:  # type: ignore
